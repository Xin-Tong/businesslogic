...
$routeObj->get('/manage/groups/collaborators', array('ManageController', 'groupsCollaborators'));
$routeObj->get('/manage/groups/collaborator/(.*)/view', array('ManageController', 'groupsCollaborator'));
...
$routeObj->get('/photos/upload/?([a-z0-9]{10})?', array('PhotoController', 'upload')); // view the upload photo form
